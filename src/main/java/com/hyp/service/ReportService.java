...
public class ReportService extends BaseServiceImpl<Report, String> {
    ...
    public List<Document> executeReport(Report report, ReportRequest reportRequest) throws BadRequestException {
        ...
        return mongoTemplate
                .aggregate(aggregation, report.getCollectionName(), Document.class)
                .getMappedResults();
    }

    private List<Document> buildQueryWithParams(List<Map<String, Object>> storedQuery, Map<String, Object> parameters)
