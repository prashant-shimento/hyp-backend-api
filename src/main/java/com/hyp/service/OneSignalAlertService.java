...
public class OneSignalAlertService {
    ...
    public void notifyRiderNotMovingAlert(
        ...
        String messageBody = oneSignalNotificationTemplates.buildRiderNotMovingAlertMessage(
    ...
    public void notifyNewOrder(
            ...
            String restaurantName) {
        String messageBody = oneSignalNotificationTemplates.buildNewOrderNotificationMessage(
        ...
        log.info(
                "Sending OneSignal static notification [appId={}, segments={}]",
                request.getAppId(),
    ...
    public void notifyMenuPush(String restaurantname, String restaurantid, String menusharingcode) {
        ...
        try {
            ...
            log.error(
                    "Error sending Menu Push notification for restaurantId={} — payload={}", restaurantid, request, e);
        }
    }
    ...
    public void notifyOrderTrackDelay(
            ...
            long finalMinutesSinceCreation,
            String nextExpected) {
        String messageBody = oneSignalNotificationTemplates.buildOrderTrackAlertMessage(
                orderId, restaurantName, currentStatus, finalMinutesSinceCreation, nextExpected);
