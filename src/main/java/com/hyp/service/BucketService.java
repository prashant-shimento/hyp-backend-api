...
public class BucketService {
	...
	public String uploadItemImageFile(FileUploadRequest fileUploadRequest) throws Exception {
		try (B2StorageClient client = B2StorageClientFactory.createDefaultFactory().create(bucketId, bucketKey,
				"BackBlazeUpload")) {
	...
	public String uploadFileFromStream(OutputStream outputStream, String fileName, String folderPath,
