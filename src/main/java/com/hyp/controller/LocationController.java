...
public class LocationController {
    ...
    public ResponseEntity<Response> getLocationPrediction(@RequestParam String search) {
        ...
        try {
            ...
            response =
                    new Response(Collections.singletonList(placePredictionData), false, "Location Prediction Fetched");
    ...
    public ResponseEntity<Response> getPlace(
            @PathVariable String entityId, @RequestBody LocationRequest locationRequest) {
        Response response;
        ...
        try {
            ...
            if (locationRequest.getPlaceId() != null) {
                ...
                GeocodingResult[] geocodingResults = locationService.getPlaceByGeocodeByClient(
            ...
            if (restaurant != null) {
                restaurantList = locationService.getServiceableRestaurants(
                        addressPlaceData, Collections.singletonList(restaurant));
            } else {
                restaurantList =
                        locationService.getServiceableRestaurants(addressPlaceData, partner.getRestaurantDetails());
            }
            ...
            response = new Response(
                    Collections.singletonList(PlaceData.builder()
                            .address(addressPlaceData)
                            .restaurants(restaurantList)
                            .build()),
                    false,
                    "Location Place Data Fetched");
            return ResponseEntity.ok(response);
        } catch (Exception e) {
