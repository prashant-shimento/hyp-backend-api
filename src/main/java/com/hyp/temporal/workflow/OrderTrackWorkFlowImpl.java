    ...
    public void handleOrderTrack(String orderId) {
        ...
        try {
            ...
            final String[] expectedStatuses = {
                "ACCEPTED", "SEARCHING_RIDER", "OUT_FOR_PICKUP", "OUT_FOR_DELIVERY", "DELIVERED", "DELIVERED"
            };
            final String[] currentStatuses = {
                "PAID", "ACCEPTED", "SEARCHING_RIDER", "OUT_FOR_PICKUP", "OUT_FOR_DELIVERY", "OUT_FOR_DELIVERY"
            };
            ...
            while (true) {
                ...
                log.info(
                        "Order {} status after {} minutes: {} (effectiveStatus={}, currentStartIndex={})",
                        orderId,
                ...
                if ("DELIVERED".equalsIgnoreCase(actualStatus) || "CANCELLED".equalsIgnoreCase(actualStatus)) {
                    log.info(
                            "Order {} {} after {} minutes since creation. WORKFLOW COMPLETING SUCCESSFULLY.",
                            orderId,
                ...
                for (int idx = currentStartIndex; idx < alertTimings.length; idx++) {
                    ...
                    if (minutesSinceCreation >= alertTimings[shiftedIndex] && !alertsSent[idx]) {
                        ...
                        if (currentStatuses[idx].equalsIgnoreCase(effectiveStatus)) {
                            ...
                            log.info(
                                    "Order {} has progressed past {} status at {} minutes - no alert needed",
                                    orderId,
                                    currentStatuses[idx],
                                    minutesSinceCreation);
                        }
