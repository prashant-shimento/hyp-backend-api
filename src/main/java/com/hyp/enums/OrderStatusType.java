...
public enum OrderStatusType {
	...
	SEARCHING_RIDER, RIDER_ASSIGNED, OUT_FOR_PICKUP, REACHED_PICKUP, PICKED_UP, OUT_FOR_DELIVERY, IN_TRANSIT,
	REACHED_DELIVERY, DELIVERED, CANCELLED, DELIVERY_CANCELLED, DROPPED_OFF, ERROR, POS_ERROR, DELIVERY_ERROR,
	PAYMENT_ERROR, REFUND_INITIATED, REFUND_COMPLETED, REFUND_FAILED, REFUND_PENDING, RIDER_CANCELLED;
