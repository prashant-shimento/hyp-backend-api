...
public class PosOrderRequestTranslation {
    ...
    public PosRiderUpdateRequest getPosRiderStatusUpdateRequest(
            Restaurant restaurant, Order order, RiderDetails riderDetails, String riderStatus) {
    ...
    public OrderInfoDetails getOrderInfoDetails(
            Restaurant restaurant, Order order, Customer customer, Address address) {
    ...
    public OrderRequest getOrderDetails(Order order, Restaurant restaurant) {
        ...
        orderDetails.setDeliveryCharges(CommonUtils.emptyIfNullOrZeroToString(
                orderDetails.getEnableDelivery() == Constants.RESTAURANT_HANDLE_DELIVERY
