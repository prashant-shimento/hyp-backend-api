...
public class UrbanPiperCallbackTranslator {
    ...
    public PosCallbackRequest translateToPosCallback(UrbanPiperOrderStatusRequest urbanPiperRequest, String locationRefId) {
        ...
        log.info("Translated to PosCallbackRequest: orderId={}, restaurantId={}, status={}", 
