...
public class PdfGenerator {
    ...
    private static final String TOP_IMAGE_PATH = "src/main/resources/images/top.png";
    private static final String BOTTOM_IMAGE_PATH = "src/main/resources/images/bottom.png";
    private static final String BOLD_FONT_PATH = "src/main/resources/fonts/noto-bold.ttf";
    private static final String REGULAR_FONT_PATH = "src/main/resources/fonts/noto-regular.ttf";
    private static final String INVOICE_TOP_IMAGE_PATH = "src/main/resources/images/top_invoice.png";
    private static final String INVOICE_BOTTOM_IMAGE_PATH = "src/main/resources/images/bottom_invoice.png";
    ...
    public static void generatePdf(String outputPath, Map<String, Object> reportData) throws Exception {
        ...
        PdfFont regular =
                PdfFontFactory.createFont(REGULAR_FONT_PATH, PdfFontFactory.EmbeddingStrategy.PREFER_EMBEDDED);
    ...
    private static void addRow(
            Table table, String key, String value, PdfFont keyFont, PdfFont valueFont, boolean header) {
