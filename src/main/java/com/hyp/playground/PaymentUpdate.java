...
public class PaymentUpdate {
    public static void main(String[] args) {
        try (MongoClient mongoClient = MongoClients.create("mongodb+srv://apiuser:IggL9Oyj26ehmp83@production.n3ybxpg.mongodb.net")) {
            ...
            List<Document> results = orderCollection.aggregate(Arrays.asList(
            ...
            Map<String, String> orderIdStatusMap = paymentOrderIds.stream().collect(Collectors.toMap(
                    orderId -> orderId,
                    orderId -> {
                        try {
                            RazorpayClient razorpayClient = new RazorpayClient("rzp_live_oUdd0v4WZIGGRP", "vX3Ov1gnhzox3LeHEHANxPO8");
