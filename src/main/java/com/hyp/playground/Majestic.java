...
public class Majestic {
    ...
    public Map<String, List<Employee>> sortMap(Map<String, List<Employee>> employees) {
        ...
        Map<String, List<Employee>> sortedBySalary = employees.entrySet().stream()
    ...
    public static void main(String[] args) {
        ...
        //		Given an Employee class with attributes (id, name, salary, gender, departmentName) and a map
        // (Map<departmentName, List<Employee>>)
        //		mapping department names to lists of employees,
        //		You need to sort the employee list within each department by salary in descending order (highest salary
        // first)?
        ...
        // eemployees.stream().sorted(Comparator.comparingDouble(Employee::getSalary)).collect(Collectors.toList());
