...
public interface Constants {
	...
	List<String> ORDER_API_PARAMS = Arrays.asList("id", "status", "customerId", "preOrder", "createdAt", "totalAmount",
			"orderType", "orderTime", "restaurantId");
	...
	List<String> RESTAURANT_API_PARAMS = Arrays.asList("id", "restaurantName", "active", "serviceable",
			"menuSharingCode", "contact");
	...
	List<String> SETTLEMENT_API_PARAMS = Arrays.asList("id", "partnerId", "restaurantId", "orderId", "createdAt",
			"updatedAt", "settlementStatus");
