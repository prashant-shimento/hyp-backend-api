...
public class RestuarantControllerTest {
	...
	@InjectMocks
	private BaseController<RestaurantDto, Restaurant, String> restaurantController = new BaseController<RestaurantDto, Restaurant, String>() {};
	...
	//Test to get all
		...
		//UTC for find By Id - Not found
		  ...
		  public void testForCreate_InternalServerError() {
		      ...
		      when(restaurantTranslation.getEntity(restaurant1Dto)).thenReturn(restaurant1);
		      when(restaurantService.save(restaurant1))
