...
public class MenuControllerTest {
	...
	//getCategoryItems when Id is null
		...
		public void testForGetCategoryItems_IdIsNull() {
			...
			RuntimeException exception = assertThrows(RuntimeException.class, ()-> categoryService.getAllCategoryItems(restaurantId));
	...
	//Get category by category By Id - when Id is null
		...
		public void testForGetCategoryDetailsById_IdIsNull() {
			...
			RuntimeException exception = assertThrows(RuntimeException.class, ()-> categoryService.getCategoryItemsById(categoryId));
