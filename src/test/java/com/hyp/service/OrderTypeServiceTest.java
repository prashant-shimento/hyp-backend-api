	 ...
	 @Mock
	    ...
	    public void testForFindById_InternalServerErrror() {
	    	...
	    	when(orderTypeRepository.findById(id)).thenThrow(new IllegalArgumentException("Id can't be null"));
	    	 ...
	    	 IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> orderTypeService.findById(id));
	    ...
	    public void testForFindById_NotFound() {
	    	String id = "viv123";
	    	when(orderTypeRepository.findById(id)).thenThrow(new EntityNotFoundException("Entity not found with ID: " + id));
	    	EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> orderTypeService.findById(id));
	  ...
	  //UTC for findAll
	    ...
	    public void testForSave_IllegalArguments() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> orderTypeService.save(entity));
	  ...
	  //UTC for save All - Illegal Arguments
	    ...
	    public void testForSaveAll_IllegalArguments() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> orderTypeService.saveAll(entities));
	  ...
	  //UTC for save All run time exception
	    ...
	    public void testForUpdate_IllegalArguments() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> orderTypeService.update(entity));
...
//	    	when(orderTypeRepository.existsById(id)).thenReturn(true);
	  ...
	  //UTC for is Exists By Id
	    ...
	    public void testForIsExistsById_IdIsNull() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> orderTypeService.isExistsById(id));
