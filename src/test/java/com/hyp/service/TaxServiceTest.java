	 ...
	 @Mock
	    ...
	    public void testForFindById_InternalServerErrror() {
	    	...
	    	when(taxRepository.findById(id)).thenThrow(new IllegalArgumentException("Id can't be null"));
	    	 ...
	    	 IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> taxService.findById(id));
	  ...
	  //UTC for findAll
	    ...
	    public void testForSave_IllegalArguments() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> taxService.save(entity));
	  ...
	  //UTC for save All - Illegal Arguments
	    ...
	    public void testForSaveAll_IllegalArguments() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> taxService.saveAll(entities));
	  ...
	  //UTC for save All run time exception
	    ...
	    public void testForUpdate_IllegalArguments() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> taxService.update(entity));
...
//	    	when(taxRepository.existsById(id)).thenReturn(true);
	  ...
	  //UTC for is Exists By Id
	    ...
	    public void testForIsExistsById_IdIsNull() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> taxService.isExistsById(id));
