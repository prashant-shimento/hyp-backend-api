	 ...
	 @Mock
	    ...
	    public void testForFindById_InternalServerErrror() {
	    	...
	    	when(offerRepository.findById(id)).thenThrow(new IllegalArgumentException("Id can't be null"));
	    	 ...
	    	 IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> offerService.findById(id));
	    ...
	    public void testForFindById_NotFound() {
	    	...
	    	EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> offerService.findById(id));
	  ...
	  //UTC for findAll
	    ...
	    public void testForSave_IllegalArguments() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> offerService.save(entity));
	  ...
	  //UTC for save All - Illegal Arguments
	    ...
	    public void testForSaveAll_IllegalArguments() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> offerService.saveAll(entities));
	  ...
	  //UTC for save All run time exception
	    ...
	    public void testForUpdate_IllegalArguments() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> offerService.update(entity));
...
//	    	when(offerRepository.existsById(id)).thenReturn(true);
	  ...
	  //UTC for is Exists By Id
	    ...
	    public void testForIsExistsById_IdIsNull() {
	    	...
	    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> offerService.isExistsById(id));
