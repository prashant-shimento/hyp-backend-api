...
public class PartnerServiceTest {
    ...
    public void testForfindPartnersByRestaurantId_SUCCESS() {
        ...
        when(partnerRepository.findByRestaurantsContainingAndType(restaurantId, type))
                .thenReturn(partner);
    ...
    public void testForfindPartnersByRestaurantId_IdIsNull() {
        ...
        when(partnerRepository.findByRestaurantsContainingAndType(restaurantId, type))
                .thenThrow(new RuntimeException("Id or type are null"));

        RuntimeException exception = assertThrows(
                RuntimeException.class, () -> partnerService.findPartnersByRestaurantId(restaurantId, type));
