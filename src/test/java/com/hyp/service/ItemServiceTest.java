...
public class ItemServiceTest {
    ...
    public void testForFindById_InternalServerErrror() {
    	...
    	when(itemRepository.findById(id)).thenThrow(new IllegalArgumentException("Id can't be null"));
    	 ...
    	 IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> itemService.findById(id));
    ...
    public void testForSave_IllegalArguments() {
    	...
    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> itemService.save(entity));
  ...
  //UTC for save All - Illegal Arguments
    ...
    public void testForSaveAll_IllegalArguments() {
    	...
    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> itemService.saveAll(entities));
  ...
  //UTC for save All run time exception
    ...
    public void testForUpdate_IllegalArguments() {
    	...
    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> itemService.update(entity));
...
//    	when(itemRepository.existsById(id)).thenReturn(true);
  ...
  //UTC for is Exists By Id
    ...
    public void testForIsExistsById_IdIsNull() {
    	...
    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> itemService.isExistsById(id));
