	...
	RestaurantService restaurantService;
	 ...
	 @Mock
	    ...
	    public void testForFindById_NotFound() {
	    	String id = "viv123";
	    	when(restaurantRepository.findById(id)).thenThrow(new EntityNotFoundException("Entity not found with ID: " + id));
...
//	    	when(restaurantRepository.existsById(id)).thenReturn(true);
	 ...
	 // UTC for find By MenuSharingCode - When Id is null
	    ...
	    public void testForfindByMenuSharingCode_IdIsNull() {
	    	...
	    	RuntimeException exception = assertThrows(RuntimeException.class, ()-> restaurantService.findByMenuSharingCode(menusharingcode));
