...
public class OrderServiceTest {
    ...
    public void testForFindById_InternalServerErrror() {
    	...
    	when(orderRepository.findById(id)).thenThrow(new IllegalArgumentException("Id can't be null"));
    	 ...
    	 IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> orderService.findById(id));
    ...
    public void testForFindById_NotFound() {
    	...
    	EntityNotFoundException exception = assertThrows(EntityNotFoundException.class, () -> orderService.findById(id));
    ...
    public void testForSave_IllegalArguments() {
    	...
    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> orderService.save(entity));
  ...
  //UTC for save All - Illegal Arguments
    ...
    public void testForSaveAll_IllegalArguments() {
    	...
    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> orderService.saveAll(entities));
  ...
  //UTC for save All run time exception
    ...
    public void testForUpdate_IllegalArguments() {
    	...
    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> orderService.update(entity));
...
//    	when(orderRepository.existsById(id)).thenReturn(true);
  ...
  //UTC for is Exists By Id
    ...
    public void testForIsExistsById_IdIsNull() {
    	...
    	IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> orderService.isExistsById(id));
